        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BasketDishes_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BasketDishes_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketDishes_OrderId",
                table: "BasketDishes",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_BasketDishes_UserId_DishId_OrderId",
                table: "BasketDishes",
                columns: new[] { "UserId", "DishId", "OrderId" },
                unique: true);
